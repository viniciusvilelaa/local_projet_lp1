...
std::string change_Language(std::vector<fileInfo> vetorDeArquivos){
  std::string typeLanguage;
  for (auto file : vetorDeArquivos){
    if(file.language == "cpp"){
      typeLanguage = "C++";
    }
    else if(file.language == "h"){
      typeLanguage = "C/C++ header";
    }
    else if(file.language == "C"){
      typeLanguage = "C";
    }
    else if(file.language == "hpp"){
      typeLanguage = "C++ header";
    }
...
void print_Infos(std::vector<fileInfo> vetorDeArquivos, width widths, std::string x)
{
...
void print_table(std::vector<fileInfo> vetorDeArquivos, width widths)
{
    ...
    print_Infos(vetorDeArquivos, widths, change_Language(vetorDeArquivos));
